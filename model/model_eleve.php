<?php
class model_eleve extends abstract_model{
	
	protected $sClassRow='row_eleve';
	
	protected $sTable='eleve';
...
class row_eleve extends abstract_row{
	
	protected $sClassModel='model_eleve';
