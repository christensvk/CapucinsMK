<?php
class model_entreprise extends abstract_model{
	
	protected $sClassRow='row_entreprise';
	
	protected $sTable='entreprise';
...
class row_entreprise extends abstract_row{
	
	protected $sClassModel='model_entreprise';
