<?php
class model_professeur extends abstract_model{
	
	protected $sClassRow='row_professeur';
	
	protected $sTable='professeur';
...
class row_professeur extends abstract_row{
	
	protected $sClassModel='model_professeur';
