<?php
class model_tuteur extends abstract_model{
	
	protected $sClassRow='row_tuteur';
	
	protected $sTable='tuteur';
...
class row_tuteur extends abstract_row{
	
	protected $sClassModel='model_tuteur';
	
    public function findEntreprise(){
		return model_entreprise::getInstance()->findById($this->idEntreprise);
	}
